...
Super build of all editor types, initially created from Classic editor v29.2.0 `stable` branch.

Add extra editor packages:
...
See `./src/ckeditor.js` for new configuration.
